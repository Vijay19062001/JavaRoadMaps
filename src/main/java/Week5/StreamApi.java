...
public class StreamApi {
    ...
    public static void main(String[] args) {
        List<String> names = Arrays.asList("John", "Alice", "Bob", "David", "Alice", "Eve", "Frank", "John");
        ...
        // 10. collect(Collector): Collect the names into a list (Already shown in earlier examples)
        ...
        System.out.println("Shortest Name: " + shortestName.orElse("No names"));
